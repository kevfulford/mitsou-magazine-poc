...
/* harmony import */ var _store_scheme__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _store_breakpoint__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _extensions_group_block_posts_query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _extensions_unique_class__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(95);
/* harmony import */ var _extensions_background_image__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(98);
/* harmony import */ var _extensions_spacings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(106);
/* harmony import */ var _extensions_border__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(110);
/* harmony import */ var _extensions_responsive_settings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(119);
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/**
 * WordPress dependencies
 */
const {
...
registerStore( 'canvas/scheme', { reducer: _reducer__WEBPACK_IMPORTED_MODULE_0__["default"], selectors: _selectors__WEBPACK_IMPORTED_MODULE_1__, actions: _actions__WEBPACK_IMPORTED_MODULE_2__ } );
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateScheme", function() { return updateScheme; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9);
/**
 * WordPress dependencies
 */
const {
...
registerStore( 'canvas/breakpoint', { reducer: _reducer__WEBPACK_IMPORTED_MODULE_0__["default"], selectors: _selectors__WEBPACK_IMPORTED_MODULE_1__, actions: _actions__WEBPACK_IMPORTED_MODULE_2__ } );
...
function getBreakpoint( state, data ) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateBreakpoint", function() { return updateBreakpoint; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_query_control__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
/* harmony import */ var _gutenberg_utils_get_parent_block__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93);
/* harmony import */ var _posts_block__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(94);
...
function getAllPostsBlocks(block) {
  ...
  if (block.innerBlocks && block.innerBlocks.length) {
    block.innerBlocks.forEach(function (innerBlock) {
      result = [].concat(_toConsumableArray(result), _toConsumableArray(getAllPostsBlocks(innerBlock)));
    });
  }
...
var withInspectorControl = createHigherOrderComponent(function (OriginalComponent) {
  var CanvasGroupPostsQueryWrapper = /*#__PURE__*/function (_Component) {
    _inherits(CanvasGroupPostsQueryWrapper, _Component);

    var _super = _createSuper(CanvasGroupPostsQueryWrapper);

    function CanvasGroupPostsQueryWrapper() {
      var _this;

      _classCallCheck(this, CanvasGroupPostsQueryWrapper);

      _this = _super.apply(this, arguments);
      _this.update = _this.update.bind(_assertThisInitialized(_this));
      _this.getQueryAttrs = _this.getQueryAttrs.bind(_assertThisInitialized(_this));
      _this.updateQueryAttrs = _this.updateQueryAttrs.bind(_assertThisInitialized(_this));
      _this.maybeUpdatePostsBlockAttrs = _this.maybeUpdatePostsBlockAttrs.bind(_assertThisInitialized(_this));
      return _this;
    }

    _createClass(CanvasGroupPostsQueryWrapper, [{
      ...
      value: function update() {
        var _this$props = this.props,
            ...
            canvasPostsBlocks = _this$props.canvasPostsBlocks,
            allowCanvasPostsQuery = _this$props.allowCanvasPostsQuery;
      ...
      key: "getQueryAttrs",
      value: function getQueryAttrs() {
        var canvasPostsBlocks = this.props.canvasPostsBlocks;
        ...
        if (!this.canvasPostsGroupAttrs) {
          ...
          if (canvasPostsBlocks && canvasPostsBlocks.length) {
            if (canvasPostsBlocks[0].attributes && canvasPostsBlocks[0].attributes.query) {
              this.canvasPostsGroupAttrs.query = _objectSpread(_objectSpread({}, this.canvasPostsGroupAttrs.query), canvasPostsBlocks[0].attributes.query);
            }
      ...
      key: "updateQueryAttrs",
      value: function updateQueryAttrs(newAttrs) {
        var currentAttrs = this.getQueryAttrs();
        this.canvasPostsGroupAttrs = _objectSpread(_objectSpread(_objectSpread({}, currentAttrs), newAttrs), {}, {
          query: _objectSpread(_objectSpread({}, currentAttrs.query), newAttrs.query || {})
        });
        this.update();
      }
      /**
      ...
      key: "maybeUpdatePostsBlockAttrs",
      value: function maybeUpdatePostsBlockAttrs(blocks) {
        var _this2 = this;
        ...
        var newAttrs = this.getQueryAttrs();
        var queryString = JSON.stringify(newAttrs);
        blocks.forEach(function (_ref) {
          var clientId = _ref.clientId,
              attributes = _ref.attributes;
          var postsQueryString = JSON.stringify({
            avoidDuplicatePosts: attributes.avoidDuplicatePosts,
            query: attributes.query
          });

          if (attributes.relatedPosts || postsQueryString !== queryString) {
            updateBlockAttributes(clientId, {
              relatedPosts: false,
              avoidDuplicatePosts: newAttrs.avoidDuplicatePosts,
              query: _objectSpread({}, newAttrs.query)
            });
          }
        });
        setTimeout(function () {
          _this2.groupBlockAttrsBusy = false;
        }, 100);
      }
    }, {
      key: "render",
      value: function render() {
        ...
        var _this$props2 = this.props,
            ...
            allowCanvasPostsQuery = _this$props2.allowCanvasPostsQuery;

        if (!attributes.canvasPostsQuery && !allowCanvasPostsQuery) {
          return wp.element.createElement(OriginalComponent, this.props);
        }

        var postsGroupAttrs = attributes.canvasPostsQuery ? this.getQueryAttrs() : {}; // add new spacings controls.

        return wp.element.createElement(Fragment, null, wp.element.createElement(OriginalComponent, this.props), wp.element.createElement(InspectorControls, null, wp.element.createElement(PanelBody, {
        ...
        }), attributes.canvasPostsQuery ? wp.element.createElement(Fragment, null, wp.element.createElement(_components_query_control__WEBPACK_IMPORTED_MODULE_1__["default"], {
          value: postsGroupAttrs.query,
          onChange: function onChange(val) {
            _this3.updateQueryAttrs({
              query: val
            });
          }
        }), wp.element.createElement(ToggleControl, {
    ...
    return CanvasGroupPostsQueryWrapper;
  }(Component);
  ...
  return compose(withSelect(function (select, ownProps) {
    ...
    var currentBlock = getBlock(ownProps.clientId);
    var rootBlock = getBlock(getBlockHierarchyRootClientId(ownProps.clientId));
    var parentBlocks = getBlockParents(ownProps.clientId);
    var canvasPostsBlocks = getAllPostsBlocks(currentBlock);
    var isInsideAnotherGroupQuery = false; // Trying to find parent Posts Group block.

    if (rootBlock && (undefined === _typeof(rootBlock.attributes.ref) || !rootBlock.attributes.ref) && parentBlocks) {
    ...
    return {
      ...
      canvasPostsBlocks: canvasPostsBlocks
    };
...
}, 'withInspectorControl'); // Init filters.
...
// Module
exports.push([module.i, ".cnvs-extension-group-posts-query-notice {\n  margin-left: 0;\n  margin-right: 0;\n  margin-bottom: 10px; }\n", ""]);
  ...
  _createClass(ComponentQueryControl, [{
    ...
    value: function render() {
      ...
      var _this$props$value = this.props.value,
          ...
          _this$props$value$exc = _this$props$value.exclude_categories,
          exclude_categories = _this$props$value$exc === void 0 ? '' : _this$props$value$exc,
          _this$props$value$exc2 = _this$props$value.exclude_tags,
          exclude_tags = _this$props$value$exc2 === void 0 ? '' : _this$props$value$exc2,
...
/* harmony default export */ __webpack_exports__["default"] = (withSelect(function (select, props, a, b, c) {
  ...
  var value = props.value;
  var slugs = value ? value.split(',') : []; // find non-cached categories and try to retrieve.
...
/* harmony default export */ __webpack_exports__["default"] = (withSelect(function (select, props, a, b, c) {
  ...
  var value = props.value;
  var slugs = value ? value.split(',') : []; // find non-cached tags and try to retrieve.
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gutenberg_utils_get_parent_block__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(93);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function hidePostsQuery(sectionFields, _ref) {
  ...
  var _wp$data$select = wp.data.select('core/block-editor'),
      getBlockHierarchyRootClientId = _wp$data$select.getBlockHierarchyRootClientId,
  ...
  var rootBlock = getBlock(getBlockHierarchyRootClientId(blockProps.clientId));
  var parentBlocks = getBlockParents(blockProps.clientId);
  var groupQueryBlock = false; // Trying to find parent Posts Group block.
  ...
  if (groupQueryBlock) {
    return wp.element.createElement(Fragment, null, wp.element.createElement(Notice, {
      status: "warning",
      isDismissible: false,
      className: "cnvs-extension-group-posts-query-notice"
    }, __('This post block is located inside the "Group" block with enabled global Query settings. Please, change these settings in the parent "Group" block.', 'canvas')), wp.element.createElement(Button, {
      isPrimary: true,
      onClick: function onClick() {
...
var withGroupAttribute = createHigherOrderComponent(function (OriginalComponent) {
  var CanvasPostsQueryGroupController = /*#__PURE__*/function (_Component) {
    _inherits(CanvasPostsQueryGroupController, _Component);

    var _super = _createSuper(CanvasPostsQueryGroupController);

    function CanvasPostsQueryGroupController() {
      var _this;

      _classCallCheck(this, CanvasPostsQueryGroupController);
    ...
    _createClass(CanvasPostsQueryGroupController, [{
      key: "componentDidMount",
      value: function componentDidMount() {
        this.update();
      }
      ...
      value: function update() {
        var _this$props = this.props,
            name = _this$props.name,
            groupQueryBlock = _this$props.groupQueryBlock,
            attributes = _this$props.attributes,
    ...
    return CanvasPostsQueryGroupController;
  }(Component);
  ...
  return compose(withSelect(function (select, ownProps) {
    ...
    return {
      groupQueryBlock: groupQueryBlock
    };
...
/* harmony import */ var _utils_is_core_block_with_ext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(97);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function addAttribute(blockSettings, name) {
  var supports = hasBlockSupport(blockSettings, 'canvasUniqueClass', false) || hasBlockSupport(blockSettings, 'canvasBackgroundImage', false) || hasBlockSupport(blockSettings, 'canvasSpacings', false) || hasBlockSupport(blockSettings, 'canvasBorder', false) || hasBlockSupport(blockSettings, 'canvasResponsive', false); // add support to core blocks

  if (Object(_utils_is_core_block_with_ext__WEBPACK_IMPORTED_MODULE_1__["default"])(name)) {
    blockSettings.supports = _objectSpread(_objectSpread({}, blockSettings.supports), {}, {
...
var withInspectorControl = createHigherOrderComponent(function (OriginalComponent) {
  var CanvasUniqueClassNameWrapper = /*#__PURE__*/function (_Component) {
    _inherits(CanvasUniqueClassNameWrapper, _Component);

    var _super = _createSuper(CanvasUniqueClassNameWrapper);

    function CanvasUniqueClassNameWrapper() {
      var _this;

      _classCallCheck(this, CanvasUniqueClassNameWrapper);

      _this = _super.apply(this, arguments);
      _this.getAllBlocks = _this.getAllBlocks.bind(_assertThisInitialized(_this));
      _this.maybeCreateUniqueClassName = _this.maybeCreateUniqueClassName.bind(_assertThisInitialized(_this));
      return _this;
    }

    _createClass(CanvasUniqueClassNameWrapper, [{
      key: "componentDidMount",
      value: function componentDidMount() {
      ...
      value: function getAllBlocks() {
        ...
        var blocks = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
        var result = [];
        ...
        blocks.forEach(function (data) {
          ...
          if (data.innerBlocks && data.innerBlocks.length) {
            result = [].concat(_toConsumableArray(result), _toConsumableArray(_this2.getAllBlocks(data.innerBlocks)));
          }
        });
        return result;
      }
      ...
      key: "maybeCreateUniqueClassName",
      value: function maybeCreateUniqueClassName(checkDuplicates) {
        var _this$props = this.props,
            name = _this$props.name,
            attributes = _this$props.attributes,
            setAttributes = _this$props.setAttributes,
        ...
        if (!hasBlockSupport(name, 'canvasUniqueClass', false) && !hasBlockSupport(name, 'canvasBackgroundImage', false) && !hasBlockSupport(name, 'canvasSpacings', false) && !hasBlockSupport(name, 'canvasBorder', false) && !hasBlockSupport(name, 'canvasResponsive', false)) {
          return;
        }

        var canvasClassName = attributes.canvasClassName; // prevent unique ID duplication after block duplicated.

        if (checkDuplicates) {
          var allBlocks = this.getAllBlocks();
          allBlocks.forEach(function (data) {
            if (data.clientId !== clientId && data.attributes && data.attributes.canvasClassName && data.attributes.canvasClassName === canvasClassName) {
              canvasClassName = '';
            }
          });
        }
        ...
        if (!canvasClassName) {
          var newId = new Date().getTime(); // Generated HTML classes for blocks follow the `cnvs-block-{name}` nomenclature.
          // Blocks provided by Canvas drop the prefixes 'canvas/'.

          var className = 'cnvs-block-' + name.replace(/\//, '-').replace(/^canvas-/, '');
          setAttributes({
...
function addSaveProps(extraProps, blockType, attributes) {
  ...
  if (blockType.name && !/^canvas/.test(name) && attributes.canvasClassName) {
    var extAttrs = ['backgroundImage', 'backgroundPosition', 'backgroundPositionXUnit', 'backgroundPositionXVal', 'backgroundPositionYUnit', 'backgroundPositionYVal', 'backgroundAttachment', 'backgroundRepeat', 'backgroundSize', 'backgroundSizeUnit', 'backgroundSizeVal', 'marginTop', 'marginRight', 'marginBottom', 'marginLeft', 'paddingTop', 'paddingRight', 'paddingBottom', 'paddingLeft', 'borderRadiusTopLeft', 'borderRadiusTopRight', 'borderRadiusBottomLeft', 'borderRadiusBottomRight', 'borderStyle', 'canvasResponsiveHide'];
    var isCustomClassRequired = false; // responsive attributes.
    ...
    extAttrs.forEach(function (attr) {
      ...
      Object.keys(canvasBreakpoints).forEach(function (breakpoint) {
        if (!isCustomClassRequired && typeof attributes["".concat(attr, "_").concat(breakpoint)] !== 'undefined') {
          isCustomClassRequired = true;
        }
      });
    });
    ...
    if (isCustomClassRequired) {
      extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(extraProps.className, attributes.canvasClassName);
    }
  }
  ...
  return function (props) {
    if (props.name && !/^canvas/.test(props.name) && props.attributes.canvasClassName) {
      return wp.element.createElement(BlockListBlock, _extends({}, props, {
        className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(props.className, props.attributes.canvasClassName)
      }));
    } else {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return isCoreBlockWithExt; });
/**
 ...
 * @return {boolean}
 */
function isCoreBlockWithExt(name) {
  return name && /^core/.test(name) && !/^core\/block$/.test(name) && !/^core\/tag-cloud/.test(name) && !/^core\/calendar/.test(name) && !/^core\/latest-comments/.test(name) && !/^core\/rss/.test(name) && !/^core\/archives/.test(name) && !/^core\/template/.test(name);
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_is_core_block_with_ext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(97);
/* harmony import */ var _utils_dynamic_styles_by_key__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(101);
/* harmony import */ var _components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(102);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function addAttribute(blockSettings, name) {
  var supports = hasBlockSupport(name, 'canvasBackgroundImage', false);
  ...
  if (supports) {
    ...
    Object.keys(canvasBreakpoints).forEach(function (breakpoint) {
      ...
      if (!blockSettings.attributes["backgroundImage".concat(suffix)]) {
        blockSettings.attributes["backgroundImage".concat(suffix)] = {
          type: 'object'
        };
      } // Background Position.


      if (!blockSettings.attributes["backgroundPosition".concat(suffix)]) {
        blockSettings.attributes["backgroundPosition".concat(suffix)] = {
          type: 'string'
        };
      } // Background Position X Unit.


      if (!blockSettings.attributes["backgroundPositionXUnit".concat(suffix)]) {
        blockSettings.attributes["backgroundPositionXUnit".concat(suffix)] = {
          type: 'string'
        };
      } // Background Position X Val.


      if (!blockSettings.attributes["backgroundPositionXVal".concat(suffix)]) {
        blockSettings.attributes["backgroundPositionXVal".concat(suffix)] = {
          type: 'number'
        };
      } // Background Position Y Unit.


      if (!blockSettings.attributes["backgroundPositionYUnit".concat(suffix)]) {
        blockSettings.attributes["backgroundPositionYUnit".concat(suffix)] = {
          type: 'string'
        };
      } // Background Position Y Val.


      if (!blockSettings.attributes["backgroundPositionYVal".concat(suffix)]) {
        blockSettings.attributes["backgroundPositionYVal".concat(suffix)] = {
          type: 'number'
        };
      } // Background Attachment.


      if (!blockSettings.attributes["backgroundAttachment".concat(suffix)]) {
        blockSettings.attributes["backgroundAttachment".concat(suffix)] = {
          type: 'string'
        };
      } // Background Repeat.


      if (!blockSettings.attributes["backgroundRepeat".concat(suffix)]) {
        blockSettings.attributes["backgroundRepeat".concat(suffix)] = {
          type: 'string'
        };
      } // Background Size Unit.


      if (!blockSettings.attributes["backgroundSizeUnit".concat(suffix)]) {
        blockSettings.attributes["backgroundSizeUnit".concat(suffix)] = {
          type: 'string'
        };
      } // Background Size Val.


      if (!blockSettings.attributes["backgroundSizeVal".concat(suffix)]) {
        blockSettings.attributes["backgroundSizeVal".concat(suffix)] = {
          type: 'number'
        };
      }
    });
...
var withInspectorControl = createHigherOrderComponent(function (OriginalComponent) {
  return /*#__PURE__*/function (_Component) {
    _inherits(CanvasBackgroundImageWrapper, _Component);

    var _super = _createSuper(CanvasBackgroundImageWrapper);

    function CanvasBackgroundImageWrapper() {
      var _this;

      _classCallCheck(this, CanvasBackgroundImageWrapper);

      _this = _super.apply(this, arguments);
      _this.getCurrentBackgroundImageStyles = _this.getCurrentBackgroundImageStyles.bind(_assertThisInitialized(_this));
      _this.getCurrentValue = _this.getCurrentValue.bind(_assertThisInitialized(_this));
      return _this;
    }
    /**
    ...
    _createClass(CanvasBackgroundImageWrapper, [{
      key: "getCurrentBackgroundImageStyles",
      value: function getCurrentBackgroundImageStyles() {
        ...
        if (canvasClassName) {
          Object.keys(canvasBreakpoints).forEach(function (name) {
            ...
            if (typeof attributes['backgroundImage' + suffix] !== 'undefined' && attributes['backgroundImage' + suffix].id) {
              backgroundImageStyles += "background-image: url(\"".concat(attributes['backgroundImage' + suffix].url, "\"); ");
            }
            ...
            if (typeof attributes['backgroundImage'] !== 'undefined' && attributes['backgroundImage'].id) {
              if (typeof attributes['backgroundPosition' + suffix] !== 'undefined') {
                if ('custom' === attributes['backgroundPosition' + suffix]) {
                  var unitX = typeof attributes['backgroundPositionXUnit' + suffix] !== 'undefined' ? attributes['backgroundPositionXUnit' + suffix] : 'px';
                  var valX = typeof attributes['backgroundPositionXVal' + suffix] !== 'undefined' ? attributes['backgroundPositionXVal' + suffix] : '0';
                  var unitY = typeof attributes['backgroundPositionYUnit' + suffix] !== 'undefined' ? attributes['backgroundPositionYUnit' + suffix] : 'px';
                  var valY = typeof attributes['backgroundPositionYVal' + suffix] !== 'undefined' ? attributes['backgroundPositionYVal' + suffix] : '0';
                  backgroundImageStyles += "background-position: ".concat(valX).concat(unitX, " ").concat(valY).concat(unitY, "; ");
                } else {
                  backgroundImageStyles += "background-position: ".concat(attributes['backgroundPosition' + suffix], "; ");
                }
              }

              if (typeof attributes['backgroundAttachment' + suffix] !== 'undefined') {
                backgroundImageStyles += "background-attachment: ".concat(attributes['backgroundAttachment' + suffix], "; ");
              }

              if (typeof attributes['backgroundRepeat' + suffix] !== 'undefined') {
                backgroundImageStyles += "background-repeat: ".concat(attributes['backgroundRepeat' + suffix], "; ");
              }

              if (typeof attributes['backgroundSize' + suffix] !== 'undefined') {
                backgroundImageStyles += "background-size: ".concat(attributes['backgroundSize' + suffix], "; ");

                if ('custom' === attributes['backgroundSize' + suffix]) {
                  if (typeof attributes['backgroundSizeVal' + suffix] !== 'undefined') {
                    var unit = typeof attributes['backgroundSizeUnit' + suffix] !== 'undefined' ? attributes['backgroundSizeUnit' + suffix] : '%';
                    backgroundImageStyles += "background-size: ".concat(attributes['backgroundSizeVal' + suffix]).concat(unit, " auto; ");
                  }
                } else {
                  backgroundImageStyles += "background-size: ".concat(attributes['backgroundSize' + suffix], "; ");
                }
            ...
            if (backgroundImageStyles) {
              backgroundImageStyles = ".".concat(canvasClassName, " { ").concat(backgroundImageStyles, " }");

              if (suffix) {
                backgroundImageStyles = "@media (max-width: ".concat(canvasBreakpoints[name].width, "px) { ").concat(backgroundImageStyles, " } ");
              }
      ...
      key: "getCurrentValue",
      value: function getCurrentValue(name) {
        var suffix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
        var attributes = this.props.attributes;
        return attributes["".concat(name).concat(suffix)];
      }
    }, {
      key: "render",
      value: function render() {
        ...
        var _this$props = this.props,
            ...
            setAttributes = _this$props.setAttributes;
        var canvasClassName = attributes.canvasClassName;
        Object(_utils_dynamic_styles_by_key__WEBPACK_IMPORTED_MODULE_2__["default"])('background-image', canvasClassName, this.getCurrentBackgroundImageStyles());
        return wp.element.createElement(Fragment, null, wp.element.createElement(OriginalComponent, _extends({}, this.props, this.state, {
          setState: this.setState
        })), wp.element.createElement(InspectorControls, null, wp.element.createElement(PanelBody, {
          title: __('Background Image'),
          initialOpen: false
        }, wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref) {
          var responsiveSuffix = _ref.responsiveSuffix,
              ComponentResponsiveDropdown = _ref.ComponentResponsiveDropdown;
          var controlName = 'backgroundImage' + responsiveSuffix; // Get values of control.

          var id = controlName in attributes ? attributes[controlName].id : 0;
          var url = controlName in attributes ? attributes[controlName].url : '';
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Image'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(Fragment, null, wp.element.createElement(BaseControl, null, !id ? wp.element.createElement(MediaPlaceholder, {
            icon: "format-image",
            labels: {
              title: __('Image'),
              name: __('image')
            ...
            onSelect: function onSelect(image) {
              setAttributes(_defineProperty({}, controlName, {
                id: image.id,
                url: image.url
              }));
            },
        ...
        }), 'backgroundImage' in attributes && _typeof(attributes['backgroundImage']) === 'object' && attributes['backgroundImage'].id ? wp.element.createElement("div", null, wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref2) {
          ...
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Position'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(SelectControl, {
            label: false,
            help: false,
            multiple: false,
            ...
            onChange: function onChange(val) {
              setAttributes(_defineProperty({}, controlName, val));
            }
          }));
        }), wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref3) {
          var responsiveSuffix = _ref3.responsiveSuffix,
              ComponentResponsiveDropdown = _ref3.ComponentResponsiveDropdown;
          var controlName = 'backgroundPosition' + responsiveSuffix;
          ...
          if ('custom' === attributes[controlName]) {
            return wp.element.createElement(Fragment, null, wp.element.createElement("h2", {
              "class": "cnvs-component-background-image-units"
            }, __('X Position'), wp.element.createElement(ComponentResponsiveDropdown, null), wp.element.createElement("div", {
              className: "cnvs-component-background-image-units-controls"
              ...
              return wp.element.createElement(Button, {
                ...
                onClick: function onClick() {
                  setAttributes(_defineProperty({}, unitControlName, unit));
                }
              }, unit);
              ...
              onChange: function onChange(val) {
                setAttributes(_defineProperty({}, valControlName, val));
              }
            }));
          }
        }), wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref4) {
          var responsiveSuffix = _ref4.responsiveSuffix,
              ComponentResponsiveDropdown = _ref4.ComponentResponsiveDropdown;
          var controlName = 'backgroundPosition' + responsiveSuffix;
          ...
          if ('custom' === attributes[controlName]) {
            return wp.element.createElement(Fragment, null, wp.element.createElement("h2", {
              "class": "cnvs-component-background-image-units"
            }, __('Y Position'), wp.element.createElement(ComponentResponsiveDropdown, null), wp.element.createElement("div", {
              className: "cnvs-component-background-image-units-controls"
            }, units.map(function (unit) {
              var unitVal = unitControlName in attributes && attributes[unitControlName] ? attributes[unitControlName] : 'px';
              return wp.element.createElement(Button, {
        ...
        }), wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref5) {
          var responsiveSuffix = _ref5.responsiveSuffix,
              ComponentResponsiveDropdown = _ref5.ComponentResponsiveDropdown;
          var controlName = 'backgroundAttachment' + responsiveSuffix;
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Attachment'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(SelectControl, {
            label: false,
            help: false,
            multiple: false,
            value: controlName in attributes ? attributes[controlName] : '',
        ...
        }), wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref6) {
          var responsiveSuffix = _ref6.responsiveSuffix,
              ComponentResponsiveDropdown = _ref6.ComponentResponsiveDropdown;
          var controlName = 'backgroundRepeat' + responsiveSuffix;
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Repeat'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(SelectControl, {
            label: false,
            help: false,
            multiple: false,
            value: controlName in attributes ? attributes[controlName] : '',
        ...
        }), wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref7) {
          var responsiveSuffix = _ref7.responsiveSuffix,
              ComponentResponsiveDropdown = _ref7.ComponentResponsiveDropdown;
          var controlName = 'backgroundSize' + responsiveSuffix;
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Size'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(SelectControl, {
            label: false,
            help: false,
            multiple: false,
            value: controlName in attributes ? attributes[controlName] : '',
        ...
        }), wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__["default"], null, function (_ref8) {
          var responsiveSuffix = _ref8.responsiveSuffix,
              ComponentResponsiveDropdown = _ref8.ComponentResponsiveDropdown;
          var controlName = 'backgroundSize' + responsiveSuffix;
          ...
          if ('custom' === attributes[controlName]) {
            return wp.element.createElement(Fragment, null, wp.element.createElement("h2", {
              "class": "cnvs-component-background-image-units"
            }, __('Width'), wp.element.createElement(ComponentResponsiveDropdown, null), wp.element.createElement("div", {
              className: "cnvs-component-background-image-units-controls"
            }, units.map(function (unit) {
    ...
    return CanvasBackgroundImageWrapper;
  }(Component);
}, 'withInspectorControl'); // Init filters.
...
exports = module.exports = __webpack_require__(13)(false);
// Module
exports.push([module.i, ".cnvs-component-background-image-units {\n  position: relative; }\n  .cnvs-component-background-image-units .cnvs-component-background-image-units-controls {\n    position: absolute;\n    top: 0;\n    right: 0;\n    margin-bottom: 10px; }\n    .cnvs-component-background-image-units .cnvs-component-background-image-units-controls button {\n      padding: 0 6px;\n      height: auto;\n      line-height: 1;\n      background: none !important;\n      border: none !important;\n      color: #ccc !important;\n      box-shadow: none !important;\n      font-weight: normal; }\n      .cnvs-component-background-image-units .cnvs-component-background-image-units-controls button.is-primary {\n        text-decoration: underline; }\n      .cnvs-component-background-image-units .cnvs-component-background-image-units-controls button:hover, .cnvs-component-background-image-units .cnvs-component-background-image-units-controls button:focus {\n        color: #5f5f5f !important; }\n", ""]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return dynamicStylesBYkey; });
/**
 ...
 */
function dynamicStylesBYkey(suffix, key, styles) {
  if (!key || !styles || 'undefined' === typeof key) {
    return;
  }

  var styleID = "dynamic-css-".concat(suffix, "-").concat(key);

  if (document.getElementById(styleID)) {
    document.getElementById(styleID).innerHTML = styles;
  } else {
    // Get the head element.
    var head = document.head || document.getElementsByTagName('head')[0]; // Create a new style node.

    var style = document.createElement('style');
    style.id = styleID; // Set type attribute for the style node.

    style.type = 'text/css'; // Append the css rules to the style node.

    style.appendChild(document.createTextNode(styles)); // Append the style node to the head of the page.
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_is_core_block_with_ext__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(97);
/* harmony import */ var _utils_dynamic_styles_by_key__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(101);
/* harmony import */ var _components_spacings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(107);
/* harmony import */ var _components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(102);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function addAttribute(blockSettings, name) {
  var supports = hasBlockSupport(name, 'canvasSpacings', false); // add support to core blocks

  if (Object(_utils_is_core_block_with_ext__WEBPACK_IMPORTED_MODULE_0__["default"])(name)) {
    blockSettings.supports = _objectSpread(_objectSpread({}, blockSettings.supports), {}, {
      canvasSpacings: true
    });
    supports = true;
  ...
  if (supports) {
    ...
    Object.keys(canvasBreakpoints).forEach(function (breakpoint) {
      ...
      Object.keys(allSpacings).forEach(function (spacing) {
      ...
      if (!blockSettings.attributes["marginLink".concat(suffix)]) {
        blockSettings.attributes["marginLink".concat(suffix)] = {
          type: 'boolean'
        };
      }

      if (!blockSettings.attributes["paddingLink".concat(suffix)]) {
        blockSettings.attributes["paddingLink".concat(suffix)] = {
          type: 'boolean'
        };
      } // unit.


      if (!blockSettings.attributes["marginUnit".concat(suffix)]) {
        blockSettings.attributes["marginUnit".concat(suffix)] = {
          type: 'string'
        };
      }

      if (!blockSettings.attributes["paddingUnit".concat(suffix)]) {
        blockSettings.attributes["paddingUnit".concat(suffix)] = {
          type: 'string'
        };
      }
    });
...
var withInspectorControl = createHigherOrderComponent(function (OriginalComponent) {
  return /*#__PURE__*/function (_Component) {
    _inherits(CanvasSpacingsWrapper, _Component);

    var _super = _createSuper(CanvasSpacingsWrapper);

    function CanvasSpacingsWrapper() {
      var _this;

      _classCallCheck(this, CanvasSpacingsWrapper);

      _this = _super.apply(this, arguments);
      _this.getCurrentSpacingStyles = _this.getCurrentSpacingStyles.bind(_assertThisInitialized(_this));
      _this.getSpacing = _this.getSpacing.bind(_assertThisInitialized(_this));
      return _this;
    }
    /**
    ...
    _createClass(CanvasSpacingsWrapper, [{
      key: "getCurrentSpacingStyles",
      value: function getCurrentSpacingStyles() {
        var attributes = this.props.attributes;
        var canvasClassName = attributes.canvasClassName;
        var customStyles = '';
          ...
          Object.keys(canvasBreakpoints).forEach(function (name) {
            ...
            Object.keys(allSpacings).forEach(function (spacing) {
              if (typeof attributes[spacing + suffix] !== 'undefined') {
                var currentUnit = /^margin/g.test(spacing) ? marginUnit : paddingUnit;
                breakpointStyles += "".concat(allSpacings[spacing], ": ").concat(attributes[spacing + suffix]).concat(currentUnit, "; ");
              }
            });

            if (breakpointStyles) {
              breakpointStyles = ".".concat(canvasClassName, " { ").concat(breakpointStyles, " }");

              if (suffix) {
                breakpointStyles = "@media (max-width: ".concat(canvasBreakpoints[name].width, "px) { ").concat(breakpointStyles, " } ");
              }
      ...
      key: "getSpacing",
      value: function getSpacing(name) {
        var suffix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
        var attributes = this.props.attributes;
        return attributes["".concat(name).concat(suffix)];
      }
      ...
      value: function render() {
        ...
        var _this$props = this.props,
            ...
            setAttributes = _this$props.setAttributes;
        var canvasClassName = attributes.canvasClassName;
        Object(_utils_dynamic_styles_by_key__WEBPACK_IMPORTED_MODULE_1__["default"])('spacings', canvasClassName, this.getCurrentSpacingStyles()); // add new spacings controls.
        ...
        return wp.element.createElement(Fragment, null, wp.element.createElement(OriginalComponent, _extends({}, this.props, this.state, {
          ...
          var responsiveSuffix = _ref.responsiveSuffix,
              ComponentResponsiveDropdown = _ref.ComponentResponsiveDropdown;
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Margins'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(_components_spacings__WEBPACK_IMPORTED_MODULE_2__["default"], {
            prefix: "margin",
            suffix: responsiveSuffix,
            units: ['px', '%'],
            top: _this2.getSpacing('marginTop', responsiveSuffix),
            bottom: _this2.getSpacing('marginBottom', responsiveSuffix),
            left: _this2.getSpacing('marginLeft', responsiveSuffix),
            right: _this2.getSpacing('marginRight', responsiveSuffix),
            link: _this2.getSpacing('marginLink', responsiveSuffix),
            unit: _this2.getSpacing('marginUnit', responsiveSuffix),
            onChange: function onChange(attributes) {
              setAttributes(attributes);
            }
          }), wp.element.createElement("h2", null, __('Paddings'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(_components_spacings__WEBPACK_IMPORTED_MODULE_2__["default"], {
            prefix: "padding",
            suffix: responsiveSuffix,
            units: ['px', 'em', '%'],
            top: _this2.getSpacing('paddingTop', responsiveSuffix),
            bottom: _this2.getSpacing('paddingBottom', responsiveSuffix),
            left: _this2.getSpacing('paddingLeft', responsiveSuffix),
            right: _this2.getSpacing('paddingRight', responsiveSuffix),
            link: _this2.getSpacing('paddingLink', responsiveSuffix),
            unit: _this2.getSpacing('paddingUnit', responsiveSuffix),
            onChange: function onChange(attributes) {
              setAttributes(attributes);
            }
          }));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ComponentSpacings; });
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(108);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_0__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var _wp$components = wp.components,
    TextControl = _wp$components.TextControl,
    Button = _wp$components.Button;
var allSpacings = ['top', 'bottom', 'left', 'right'];
/**
 * Component
 */

var ComponentSpacings = /*#__PURE__*/function (_Component) {
  _inherits(ComponentSpacings, _Component);

  var _super = _createSuper(ComponentSpacings);

  function ComponentSpacings() {
    var _this;

    _classCallCheck(this, ComponentSpacings);
  ...
  _createClass(ComponentSpacings, [{
    key: "updateSpacing",
    value: function updateSpacing(name) {
      var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var suffix = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var val = arguments.length > 3 ? arguments[3] : undefined;
      var onChange = this.props.onChange; // TextControl return string value, we need to convert to int manually.
      ...
      var updateAttrs = _defineProperty({}, prefix + name.charAt(0).toUpperCase() + name.slice(1) + suffix, val); // Change all linked values.


      if (this.props.link) {
        allSpacings.forEach(function (spacing) {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$suffix = _this$props.suffix,
          suffix = _this$props$suffix === void 0 ? '' : _this$props$suffix,
          _this$props$units = _this$props.units,
          units = _this$props$units === void 0 ? ['px', 'em'] : _this$props$units,
          onChange = _this$props.onChange;
      return wp.element.createElement("div", {
        className: "cnvs-component-spacings"
      }, wp.element.createElement("div", {
        className: "cnvs-component-spacings-units"
      }, units.map(function (unit) {
        return wp.element.createElement(Button, {
          isPrimary: unit === 'px' ? !_this2.props.unit : _this2.props.unit === unit,
          onClick: function onClick() {
            onChange(_defineProperty({}, prefix + 'Unit' + suffix, unit === 'px' ? '' : unit));
          }
        }, unit);
      })), wp.element.createElement("div", {
        className: "cnvs-component-spacings-wrap"
      }, allSpacings.map(function (spacing) {
        var val = _this2.props[spacing];
        ...
        return wp.element.createElement(TextControl, {
          ...
          value: val,
          onChange: function onChange(val) {
            return _this2.updateSpacing(spacing, prefix, suffix, val);
          },
          autoComplete: "off"
        });
        ...
        onClick: function onClick() {
          if (_this2.props.link) {
            onChange(_defineProperty({}, prefix + 'Link' + suffix, false));
          } else {
            var _onChange3;

            onChange((_onChange3 = {}, _defineProperty(_onChange3, prefix + 'Bottom' + suffix, _this2.props.top), _defineProperty(_onChange3, prefix + 'Left' + suffix, _this2.props.top), _defineProperty(_onChange3, prefix + 'Right' + suffix, _this2.props.top), _defineProperty(_onChange3, prefix + 'Link' + suffix, true), _onChange3));
          }
        }
...
exports = module.exports = __webpack_require__(13)(false);
// Module
exports.push([module.i, ".cnvs-component-spacings {\n  position: relative; }\n  .cnvs-component-spacings .cnvs-component-spacings-units {\n    position: absolute;\n    bottom: 100%;\n    right: 0;\n    margin-bottom: 10px; }\n    .cnvs-component-spacings .cnvs-component-spacings-units button {\n      padding: 0 6px;\n      height: auto;\n      line-height: 1;\n      background: none !important;\n      border: none !important;\n      color: #ccc !important;\n      box-shadow: none !important; }\n      .cnvs-component-spacings .cnvs-component-spacings-units button.is-primary {\n        text-decoration: underline; }\n      .cnvs-component-spacings .cnvs-component-spacings-units button:hover, .cnvs-component-spacings .cnvs-component-spacings-units button:focus {\n        color: #5f5f5f !important; }\n  .cnvs-component-spacings .cnvs-component-spacings-wrap {\n    display: flex;\n    margin-top: -10px;\n    padding-bottom: 30px; }\n    .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control {\n      margin-bottom: 0 !important; }\n      .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(1) .components-text-control__input, .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(2) .components-text-control__input, .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(3) .components-text-control__input, .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(4) .components-text-control__input {\n        border-top-right-radius: 0;\n        border-bottom-right-radius: 0; }\n      .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(2), .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(3), .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(4) {\n        margin-left: -1px; }\n        .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(2) .components-text-control__input, .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(3) .components-text-control__input, .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:nth-child(4) .components-text-control__input {\n          border-top-left-radius: 0;\n          border-bottom-left-radius: 0; }\n      .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control:focus-within {\n        z-index: 1; }\n      .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control .components-base-control__field {\n        position: relative;\n        margin-bottom: 0; }\n      .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-base-control .components-base-control__label {\n        text-transform: uppercase;\n        font-size: .7em;\n        font-weight: 600;\n        opacity: 0.5;\n        position: absolute;\n        bottom: -26px;\n        left: 0;\n        right: 0;\n        text-align: center; }\n    .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-button {\n      border-top-left-radius: 0;\n      border-bottom-left-radius: 0;\n      height: auto;\n      display: block; }\n      .cnvs-component-spacings .cnvs-component-spacings-wrap > .components-button svg {\n        width: 10px;\n        height: 10px; }\n", ""]);
...
/* harmony import */ var _utils_is_core_block_with_ext__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(97);
/* harmony import */ var _utils_dynamic_styles_by_key__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(101);
/* harmony import */ var _components_colors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(111);
/* harmony import */ var _components_spacings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(107);
/* harmony import */ var _components_radius__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(112);
/* harmony import */ var _components_scheme_wrapper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(115);
/* harmony import */ var _components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(102);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function addAttribute(blockSettings, name) {
  var supports = hasBlockSupport(name, 'canvasBorder', false); // add support to core blocks
  ...
  if (supports) {
    ...
    Object.keys(canvasSchemes).forEach(function (scheme) {
      var suffix = '';

      if (scheme && 'default' !== scheme) {
        suffix = "_".concat(scheme);
      }

      if (!blockSettings.attributes["borderColor".concat(suffix)]) {
        blockSettings.attributes["borderColor".concat(suffix)] = {
          type: 'string'
        };
      }
    }); // responsive attributes.
    ...
    Object.keys(canvasBreakpoints).forEach(function (breakpoint) {
      ...
      Object.keys(allBorders).forEach(function (spacing) {
        if (!blockSettings.attributes[spacing + suffix]) {
          blockSettings.attributes[spacing + suffix] = {
            type: 'number'
          };
      ...
      if (!blockSettings.attributes["borderWidthLink".concat(suffix)]) {
        blockSettings.attributes["borderWidthLink".concat(suffix)] = {
          type: 'boolean'
        };
      } // unit.


      if (!blockSettings.attributes["borderWidthUnit".concat(suffix)]) {
        blockSettings.attributes["borderWidthUnit".concat(suffix)] = {
          type: 'string'
        };
      } // radius.


      Object.keys(allBordersRadius).forEach(function (radius) {
      ...
      if (!blockSettings.attributes["borderRadiusLink".concat(suffix)]) {
        blockSettings.attributes["borderRadiusLink".concat(suffix)] = {
          type: 'boolean'
        };
      } // unit.


      if (!blockSettings.attributes["borderRadiusUnit".concat(suffix)]) {
        blockSettings.attributes["borderRadiusUnit".concat(suffix)] = {
          type: 'string'
        };
      }
    });
...
var withInspectorControl = createHigherOrderComponent(function (OriginalComponent) {
  return /*#__PURE__*/function (_Component) {
    _inherits(CanvasBordersWrapper, _Component);

    var _super = _createSuper(CanvasBordersWrapper);

    function CanvasBordersWrapper() {
      var _this;

      _classCallCheck(this, CanvasBordersWrapper);

      _this = _super.apply(this, arguments);
      _this.getCurrentBorderStyles = _this.getCurrentBorderStyles.bind(_assertThisInitialized(_this));
      _this.getCurrentValue = _this.getCurrentValue.bind(_assertThisInitialized(_this));
      return _this;
    }
    /**
    ...
    _createClass(CanvasBordersWrapper, [{
      key: "getCurrentBorderStyles",
      value: function getCurrentBorderStyles() {
        var attributes = this.props.attributes;
        var canvasClassName = attributes.canvasClassName,
          ...
          Object.keys(canvasBreakpoints).forEach(function (name) {
            ...
            Object.keys(allBordersRadius).forEach(function (radius) {
              if (typeof attributes[radius + suffix] !== 'undefined') {
                breakpointStyles += "".concat(allBordersRadius[radius], ": ").concat(attributes[radius + suffix]).concat(borderRadiusUnit, "; ");
              }
            });
        ...
        if (canvasClassName && borderStyle) {
          var mainStyles = '';
          mainStyles = "border-style: ".concat(borderStyle, ";");
          mainStyles += "border-width: 0;";
          customStyles += ".".concat(canvasClassName, " { ").concat(mainStyles, " }");
          Object.keys(canvasSchemes).forEach(function (name) {
            ...
            if (name && 'default' !== name) {
              ...
              rule = "[data-scheme=\"".concat(name, "\"]");
            }

            if (attributes['borderColor' + suffix]) {
              mainStyles = "border-color: ".concat(attributes['borderColor' + suffix], ";");
              customStyles += "".concat(rule, " .").concat(canvasClassName, " { ").concat(mainStyles, " }");
            }
          });
          Object.keys(canvasBreakpoints).forEach(function (name) {
            var suffix = '';
            var borderWidthUnit = 'px';
            var breakpointStyles = '';
            ...
            Object.keys(allBorders).forEach(function (spacing) {
              if (typeof attributes[spacing + suffix] !== 'undefined') {
                breakpointStyles += "".concat(allBorders[spacing], ": ").concat(attributes[spacing + suffix]).concat(borderWidthUnit, "; ");
              }
            });
      ...
      value: function render() {
        ...
        var _this$props = this.props,
            ...
            setAttributes = _this$props.setAttributes;
        var canvasClassName = attributes.canvasClassName;
        Object(_utils_dynamic_styles_by_key__WEBPACK_IMPORTED_MODULE_1__["default"])('borders', canvasClassName, this.getCurrentBorderStyles()); // add new borders controls.
        ...
        return wp.element.createElement(Fragment, null, wp.element.createElement(OriginalComponent, _extends({}, this.props, this.state, {
          ...
          title: __('Borders'),
          initialOpen: false
        }, wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_6__["default"], null, function (_ref) {
          var responsiveSuffix = _ref.responsiveSuffix,
              ComponentResponsiveDropdown = _ref.ComponentResponsiveDropdown;
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Radius'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(_components_radius__WEBPACK_IMPORTED_MODULE_4__["default"], {
            prefix: "borderRadius",
            suffix: responsiveSuffix,
            units: ['px', '%'],
            topLeft: _this2.getCurrentValue('borderRadiusTopLeft', responsiveSuffix),
            topRight: _this2.getCurrentValue('borderRadiusTopRight', responsiveSuffix),
            bottomLeft: _this2.getCurrentValue('borderRadiusBottomLeft', responsiveSuffix),
            bottomRight: _this2.getCurrentValue('borderRadiusBottomRight', responsiveSuffix),
            link: _this2.getCurrentValue('borderRadiusLink', responsiveSuffix),
            unit: _this2.getCurrentValue('borderRadiusUnit', responsiveSuffix),
            onChange: function onChange(attributes) {
              setAttributes(attributes);
            }
          }));
        ...
        }), attributes.borderStyle ? wp.element.createElement(_components_responsive_wrapper__WEBPACK_IMPORTED_MODULE_6__["default"], null, function (_ref2) {
          var responsiveSuffix = _ref2.responsiveSuffix,
              ComponentResponsiveDropdown = _ref2.ComponentResponsiveDropdown;
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Width'), wp.element.createElement(ComponentResponsiveDropdown, null)), wp.element.createElement(_components_spacings__WEBPACK_IMPORTED_MODULE_3__["default"], {
            prefix: "borderWidth",
            suffix: responsiveSuffix,
            units: ['px'],
            top: _this2.getCurrentValue('borderWidthTop', responsiveSuffix),
            bottom: _this2.getCurrentValue('borderWidthBottom', responsiveSuffix),
            left: _this2.getCurrentValue('borderWidthLeft', responsiveSuffix),
            right: _this2.getCurrentValue('borderWidthRight', responsiveSuffix),
            link: _this2.getCurrentValue('borderWidthLink', responsiveSuffix),
            unit: _this2.getCurrentValue('borderWidthUnit', responsiveSuffix),
            onChange: function onChange(attributes) {
              setAttributes(attributes);
            }
          }));
        }) : '', attributes.borderStyle ? wp.element.createElement(_components_scheme_wrapper__WEBPACK_IMPORTED_MODULE_5__["default"], null, function (_ref3) {
          var schemeSuffix = _ref3.schemeSuffix,
              ComponentSchemeDropdown = _ref3.ComponentSchemeDropdown;
          return wp.element.createElement(Fragment, null, wp.element.createElement("h2", null, __('Color'), wp.element.createElement(ComponentSchemeDropdown, null)), wp.element.createElement(_components_colors__WEBPACK_IMPORTED_MODULE_2__["default"], {
            slug: 'borderColor',
            suffix: schemeSuffix,
            val: _this2.getCurrentValue('borderColor', schemeSuffix),
            onChange: function onChange(attributes) {
              setAttributes(attributes);
            }
          }));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ComponentColors; });
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var ComponentColors = /*#__PURE__*/function (_Component) {
  _inherits(ComponentColors, _Component);

  var _super = _createSuper(ComponentColors);

  function ComponentColors() {
    var _this;

    _classCallCheck(this, ComponentColors);

    _this = _super.apply(this, arguments);
    _this.updateColors = _this.updateColors.bind(_assertThisInitialized(_this));
    return _this;
  }
  /**
   * Update colors value.
  ...
  _createClass(ComponentColors, [{
    key: "updateColors",
    value: function updateColors(slug) {
      var suffix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var val = arguments.length > 2 ? arguments[2] : undefined;
      var onChange = this.props.onChange;

      var updateAttrs = _defineProperty({}, slug + suffix, val);
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$val = _this$props.val,
          val = _this$props$val === void 0 ? '' : _this$props$val,
          _this$props$suffix = _this$props.suffix,
          suffix = _this$props$suffix === void 0 ? '' : _this$props$suffix;
      return wp.element.createElement(ColorPalette, {
        value: val || '',
        onChange: function onChange(val) {
          return _this2.updateColors(slug, suffix, val);
        }
      });
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ComponentRadius; });
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(113);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_0__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var _wp$components = wp.components,
    TextControl = _wp$components.TextControl,
    Button = _wp$components.Button;
var allRadius = ['topLeft', 'topRight', 'bottomLeft', 'bottomRight'];
/**
 * Component
 */

var ComponentRadius = /*#__PURE__*/function (_Component) {
  _inherits(ComponentRadius, _Component);

  var _super = _createSuper(ComponentRadius);

  function ComponentRadius() {
    var _this;

    _classCallCheck(this, ComponentRadius);

    _this = _super.apply(this, arguments);
    _this.updateRadius = _this.updateRadius.bind(_assertThisInitialized(_this));
    return _this;
  }
  /**
   * Update number value.
  ...
  _createClass(ComponentRadius, [{
    key: "updateRadius",
    value: function updateRadius(name) {
      var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var suffix = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var val = arguments.length > 3 ? arguments[3] : undefined;
      var onChange = this.props.onChange; // TextControl return string value, we need to convert to int manually.
      ...
      if (this.props.link) {
        allRadius.forEach(function (radius) {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          onChange = _this$props.onChange;
      return wp.element.createElement("div", {
        className: "cnvs-component-radius"
      }, wp.element.createElement("div", {
        className: "cnvs-component-radius-units"
      }, units.map(function (unit) {
        return wp.element.createElement(Button, {
          isPrimary: unit === 'px' ? !_this2.props.unit : _this2.props.unit === unit,
          onClick: function onClick() {
        ...
        className: "cnvs-component-radius-wrap"
      }, allRadius.map(function (radius) {
        var val = _this2.props[radius];
        ...
        return wp.element.createElement(TextControl, {
          ...
          value: val,
          onChange: function onChange(val) {
            return _this2.updateRadius(radius, prefix, suffix, val);
          },
          autoComplete: "off"
        });
      }), wp.element.createElement(Button, {
        ...
        onClick: function onClick() {
          if (_this2.props.link) {
            ...
            onChange((_onChange3 = {}, _defineProperty(_onChange3, prefix + 'TopRight' + suffix, _this2.props.topLeft), _defineProperty(_onChange3, prefix + 'BottomLeft' + suffix, _this2.props.topLeft), _defineProperty(_onChange3, prefix + 'BottomRight' + suffix, _this2.props.topLeft), _defineProperty(_onChange3, prefix + 'Link' + suffix, true), _onChange3));
          }
        }
      }, wp.element.createElement("svg", {
        width: "20",
...
exports = module.exports = __webpack_require__(13)(false);
// Module
exports.push([module.i, ".cnvs-component-radius {\n  position: relative; }\n  .cnvs-component-radius .cnvs-component-radius-units {\n    position: absolute;\n    bottom: 100%;\n    right: 0;\n    margin-bottom: 10px; }\n    .cnvs-component-radius .cnvs-component-radius-units button {\n      padding: 0 6px;\n      height: auto;\n      line-height: 1;\n      background: none !important;\n      border: none !important;\n      color: #ccc !important;\n      box-shadow: none !important; }\n      .cnvs-component-radius .cnvs-component-radius-units button.is-primary {\n        text-decoration: underline; }\n      .cnvs-component-radius .cnvs-component-radius-units button:hover, .cnvs-component-radius .cnvs-component-radius-units button:focus {\n        color: #5f5f5f !important; }\n  .cnvs-component-radius .cnvs-component-radius-wrap {\n    display: flex;\n    margin-top: -10px;\n    padding-bottom: 30px; }\n    .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control {\n      margin-bottom: 0 !important; }\n      .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(1) .components-text-control__input, .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(2) .components-text-control__input, .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(3) .components-text-control__input, .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(4) .components-text-control__input {\n        border-top-right-radius: 0;\n        border-bottom-right-radius: 0; }\n      .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(2), .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(3), .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(4) {\n        margin-left: -1px; }\n        .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(2) .components-text-control__input, .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(3) .components-text-control__input, .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:nth-child(4) .components-text-control__input {\n          border-top-left-radius: 0;\n          border-bottom-left-radius: 0; }\n      .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control:focus-within {\n        z-index: 1; }\n      .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control .components-base-control__field {\n        position: relative;\n        margin-bottom: 0; }\n      .cnvs-component-radius .cnvs-component-radius-wrap > .components-base-control .components-base-control__label {\n        text-transform: uppercase;\n        font-size: .7em;\n        font-weight: 600;\n        opacity: 0.5;\n        position: absolute;\n        bottom: -26px;\n        left: 0;\n        right: 0;\n        text-align: center; }\n    .cnvs-component-radius .cnvs-component-radius-wrap > .components-button {\n      border-top-left-radius: 0;\n      border-bottom-left-radius: 0;\n      height: auto;\n      display: block; }\n      .cnvs-component-radius .cnvs-component-radius-wrap > .components-button svg {\n        width: 10px;\n        height: 10px; }\n", ""]);
...
function addAttribute(blockSettings, name) {
  var supports = hasBlockSupport(name, 'canvasResponsive', false); // add support to core blocks
  ...
  if (supports) {
    ...
    Object.keys(canvasBreakpoints).forEach(function (breakpoint) {
      if (!blockSettings.attributes["canvasResponsiveHide_".concat(breakpoint)]) {
        blockSettings.attributes["canvasResponsiveHide_".concat(breakpoint)] = {
          type: 'boolean'
        };
      }
    });
...
var withInspectorControl = createHigherOrderComponent(function (OriginalComponent) {
  return /*#__PURE__*/function (_Component) {
    _inherits(CanvasResponsiveWrapper, _Component);

    var _super = _createSuper(CanvasResponsiveWrapper);

    function CanvasResponsiveWrapper() {
      var _this;

      _classCallCheck(this, CanvasResponsiveWrapper);

      _this = _super.apply(this, arguments);
      _this.getResponsiveStyles = _this.getResponsiveStyles.bind(_assertThisInitialized(_this));
      return _this;
    }
    /**
    ...
    _createClass(CanvasResponsiveWrapper, [{
      key: "getResponsiveStyles",
      value: function getResponsiveStyles() {
        var _this$props = this.props,
            attributes = _this$props.attributes,
            clientId = _this$props.clientId;
        var canvasClassName = attributes.canvasClassName;
        ...
        if (canvasClassName) {
          var blockSelector = "#block-".concat(clientId);
          Object.keys(canvasBreakpoints).forEach(function (breakpoint, i) {
            var media = '';

            switch (breakpoint) {
              case 'mobile':
                media = "(max-width: ".concat(canvasBreakpoints['mobile'].width, "px)");
                break;

              case 'tablet':
                media = "(min-width: ".concat(canvasBreakpoints['mobile'].width + 1, "px) and (max-width: ").concat(canvasBreakpoints['tablet'].width, "px)");
                break;

              case 'notebook':
                media = "(min-width: ".concat(canvasBreakpoints['tablet'].width + 1, "px) and (max-width: ").concat(canvasBreakpoints['notebook'].width, "px)");
                break;

              case 'desktop':
                media = "(min-width: ".concat(canvasBreakpoints['desktop'].width, "px)");
                break;
            }

            if (attributes['canvasResponsiveHide_' + breakpoint]) {
              customStyles += "\n\t\t\t\t\t\t\t@media ".concat(media, " {\n\t\t\t\t\t\t\t\t").concat(blockSelector, "::before {\n\t\t\t\t\t\t\t\t\tbackground: rgba(0, 0, 0, 0.1) repeating-linear-gradient(125deg, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.05) 1px, transparent 2px, transparent 9px);\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t").concat(blockSelector, " {\n\t\t\t\t\t\t\t\t\t-webkit-filter: opacity(0.4) saturate(0);\n\t\t\t\t\t\t\t\t\tfilter: opacity(0.4) saturate(0);\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t");
            }
          });
        }
      ...
      value: function render() {
        ...
        var _this$props2 = this.props,
            ...
            setAttributes = _this$props2.setAttributes;
        var canvasClassName = attributes.canvasClassName;
        Object(_utils_dynamic_styles_by_key__WEBPACK_IMPORTED_MODULE_1__["default"])('responsive', canvasClassName, this.getResponsiveStyles()); // add new spacings controls.
        ...
        return wp.element.createElement(Fragment, null, wp.element.createElement(OriginalComponent, _extends({}, this.props, this.state, {
          ...
          initialOpen: false
        }, Object.keys(canvasBreakpoints).map(function (breakpoint) {
          return wp.element.createElement(ToggleControl, {
            key: breakpoint,
            label: __('Hide On ') + canvasBreakpoints[breakpoint].label,
            checked: attributes["canvasResponsiveHide_".concat(breakpoint)],
            onChange: function onChange() {
              setAttributes(_defineProperty({}, "canvasResponsiveHide_".concat(breakpoint), !attributes["canvasResponsiveHide_".concat(breakpoint)]));
            }
          });
        }))));
      }
    ...
    return CanvasResponsiveWrapper;
  }(Component);
}, 'withInspectorControl'); // Init filters.
