...
var paragraphWithCanvasDropcap = createHigherOrderComponent(function (BlockEdit) {
  var NewEdit = /*#__PURE__*/function (_Component) {
    ...
    function NewEdit() {
      ...
      _this.activeClasses = '';
      _this.getDropcapStyle = _this.getDropcapStyle.bind(_assertThisInitialized(_this));
      _this.updateDropcapStyle = _this.updateDropcapStyle.bind(_assertThisInitialized(_this));
      return _this;
    }
    /**
    ...
    _createClass(NewEdit, [{
      key: "getDropcapStyle",
      value: function getDropcapStyle() {
        var attributes = this.props.attributes;
        return Object(_gutenberg_utils_classes_replacer__WEBPACK_IMPORTED_MODULE_0__["getActiveClass"])(attributes.className, 'is-cnvs-dropcap');
      }
      /**
      ...
      key: "updateDropcapStyle",
      value: function updateDropcapStyle(dropcapName) {
        var _this$props = this.props,
            attributes = _this$props.attributes,
            onChangeClassName = _this$props.onChangeClassName;
        var updatedClassName = Object(_gutenberg_utils_classes_replacer__WEBPACK_IMPORTED_MODULE_0__["replaceClass"])(attributes.className, 'is-cnvs-dropcap', dropcapName);
      ...
      value: function render() {
        ...
        if (attributes.dropCap) {
          var dropcapStyle = this.getDropcapStyle();
