...
var canvasHeadingNumberedAdditionalAttributes = createHigherOrderComponent(function (BlockListBlock) {
  return function (props) {
    ...
    className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, "cnvs-heading-numbered-".concat(level));
    return wp.element.createElement(BlockListBlock, _extends({}, props, {
      className: className,
      wrapperProps: {
        'data-heading': "cnvs-heading-numbered-".concat(level)
      }
    }));
  };
